...
If the sides define a triangle, find its area. If not, display an invalid data message.
"""


side1, side2, side3 = map(int, input('Input triangle sides separated by a space: ').split())
