...
4. Create a tuple of one item so that iterating over that item will consistently output values 1, 2, 3. Make sure that len() of the original tuple returns 1."""
